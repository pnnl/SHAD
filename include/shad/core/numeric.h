...
OutputIt adjacent_difference(InputIt first, InputIt last,
  ...
  return impl::adjacent_difference(distributed_sequential_tag{},
                                   first, last, d_first,
                                   std::minus<value_t>());
}
...
adjacent_difference(ExecutionPolicy&& policy, InputIt first,
                    InputIt last, OutputIt d_first) {
  using value_t = typename distributed_iterator_traits<InputIt>::value_type;
  return impl::adjacent_difference(std::forward<ExecutionPolicy>(policy),
                                   first, last, d_first,
                                   std::minus<value_t>());
}
...
template <typename ExecutionPolicy, class InputIt,
...
typename std::iterator_traits<InputIt>::value_type reduce(
  ...
  return impl::reduce(distributed_sequential_tag{},
                      first, last, val_t{}, std::plus<val_t>());
}
...
reduce(ExecutionPolicy&& policy, ForwardIt first, ForwardIt last) {
  ...
  return impl::reduce(std::forward<ExecutionPolicy>(policy),
                      first, last, val_t{}, std::plus<val_t>());
}
...
OutputIt exclusive_scan(InputIt first, InputIt last,
  ...
  return impl::exclusive_scan(shad::distributed_sequential_tag{},
                              first, last, d_first, std::plus<T>(), init);
}

template <class ExecutionPolicy, class ForwardIt1, class ForwardIt2, class T>
std::enable_if_t<shad::is_execution_policy<ExecutionPolicy>::value, ForwardIt2>
exclusive_scan(ExecutionPolicy&& policy, ForwardIt1 first,
...
OutputIt inclusive_scan(InputIt first,
                        InputIt last, OutputIt d_first) {
  return impl::inclusive_scan(shad::distributed_sequential_tag{},
...
std::enable_if_t<shad::is_execution_policy<ExecutionPolicy>::value,
                 ForwardIt2>
inclusive_scan(ExecutionPolicy&& policy, ForwardIt1 first,
               ForwardIt1 last, ForwardIt2 d_first) {
  return impl::inclusive_scan(std::forward<ExecutionPolicy>(policy),
                              first, last, d_first, std::plus<>());
}

template <class InputIt, class OutputIt, class BinaryOperation>
std::enable_if_t<!shad::is_execution_policy<InputIt>::value, OutputIt>
inclusive_scan(InputIt first, InputIt last,
...
std::enable_if_t<shad::is_execution_policy<ExecutionPolicy>::value,
                 ForwardIt2>
inclusive_scan(ExecutionPolicy&& policy,
...
T transform_reduce(InputIt1 first1, InputIt1 last1,
                   InputIt2 first2, T init) {
  return impl::transform_reduce(distributed_sequential_tag{},
...
transform_reduce(InputIt first, InputIt last,
  ...
  return impl::transform_reduce(distributed_sequential_tag{},
                                first, last, init, binop, unary_op);
}

template <class ExecutionPolicy,
          class ForwardIt1, class ForwardIt2, class T>
std::enable_if_t<shad::is_execution_policy<ExecutionPolicy>::value, T>
transform_reduce(ExecutionPolicy&& policy,
...
std::enable_if_t<shad::is_execution_policy<ExecutionPolicy>::value,
                 ForwardIt2>
transform_inclusive_scan(ExecutionPolicy&& policy,
                         ForwardIt1 first, ForwardIt1 last,
                         ForwardIt2 d_first,
                         BinaryOperation binary_op,
                         UnaryOperation unary_op ) {
...
std::enable_if_t<!shad::is_execution_policy<InputIt>::value, OutputIt>
transform_inclusive_scan(InputIt first, InputIt last,
                         OutputIt d_first,
                         BinaryOperation binary_op,
                         UnaryOperation unary_op,
                         T init) {
