...
ForwardIt2 copy(std::output_iterator_tag, distributed_sequential_tag&& policy,
  ...
  for (auto locality = localities.begin(), end = localities.end();
    ...
    rt::executeAtWithRet(
        locality,
        [](const std::tuple<ForwardIt1, ForwardIt1, ForwardIt2>& args,
           ForwardIt2* res_ptr) {
          ...
          *res_ptr = std::copy(begin, end, d_first_);
        },
        std::make_tuple(first1, last1, res), &res);
  }
  return res;
}
...
template <class ForwardIt1, class ForwardIt2>
ForwardIt2 copy(std::forward_iterator_tag, distributed_sequential_tag&& policy,
                ForwardIt1 begin1, ForwardIt1 end1, ForwardIt2 d_begin) {
  using itr_traits = distributed_iterator_traits<ForwardIt1>;
  ...
  for (auto locality = localities.begin(), end = localities.end();
    ...
    rt::executeAtWithRet(
        ...
        std::make_tuple(begin1, end1, d_begin), &res);
  }
  return res;
}
...
OutputIt copy(std::output_iterator_tag, distributed_parallel_tag&& policy,
  ...
  for (auto locality = localities.begin(), end = localities.end();
    ...
    rt::asyncExecuteAtWithRet(
        h, locality,
        [](rt::Handle&, const std::tuple<ForwardIt, ForwardIt, OutputIt>& args,
           OutputIt* res_ptr) {
        ...
        std::make_tuple(first1, last1, d_first), &(*res_it));
  }
...
template <class ForwardIt1, class ForwardIt2>
ForwardIt2 copy(std::forward_iterator_tag, distributed_parallel_tag&& policy,
                ForwardIt1 begin1, ForwardIt1 end1, ForwardIt2 d_begin) {
  using itr_traits = distributed_iterator_traits<ForwardIt1>;
  auto localities = itr_traits::localities(begin1, end1);
  ...
  for (auto locality = localities.begin(), end = localities.end();
    ...
    rt::asyncExecuteAtWithRet(
        ...
        std::make_tuple(begin1, end1, d_begin), &(*res_it));
  }
  rt::waitForCompletion(h);
  return res.back();
}
...
template <class ForwardIt1, class OutputIt>
OutputIt copy(distributed_sequential_tag&& policy, ForwardIt1 begin1,
              ForwardIt1 end1, OutputIt d_begin) {
  return copy_impl::copy(
      typename std::iterator_traits<OutputIt>::iterator_category{},
      std::forward<distributed_sequential_tag>(policy), begin1, end1, d_begin);
}

template <class ForwardIt1, class OutputIt>
OutputIt copy(distributed_parallel_tag&& policy, ForwardIt1 begin1,
              ForwardIt1 end1, OutputIt d_begin) {
  return copy_impl::copy(
      typename std::iterator_traits<OutputIt>::iterator_category{},
