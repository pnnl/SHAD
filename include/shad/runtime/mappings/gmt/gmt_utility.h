    ...
    namespace rt {
        ...
        namespace impl {
            ...
            inline void execFunWrapper(const void *args, uint32_t args_size, void *,
                ...
                std::chrono::duration<double> diff = t2-t1;
                auto log_handler = shad::slog::ShadLog::Instance();
                log_handler->printlf("execFunWrapper", diff.count(), nullptr, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), RuntimeInternalsTrait<gmt_tag>::ThisLocality(), args_size - sizeof(functionPtr), 0);
#endif
            }
            ...
            inline void execFunWithRetBuffWrapper(const void *args, uint32_t argsSize,
                ...
                *reinterpret_cast<FunctionTy *>(const_cast<void *>(args));
                ...
                std::chrono::duration<double> diff = t2-t1;
                auto log_handler = shad::slog::ShadLog::Instance();
                log_handler->printlf("execFunWithRetBuffWrapper", diff.count(), nullptr, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), RuntimeInternalsTrait<gmt_tag>::ThisLocality(), argsSize - sizeof(functionPtr), sizeof(*resultSize));
#endif
            }
            ...
            void execFunWithRetWrapper(const void *args, uint32_t args_size, void *result,
                ...
                *resSize = sizeof(ResT);
                ...
                std::chrono::duration<double> diff = t2-t1;
                auto log_handler = shad::slog::ShadLog::Instance();
                log_handler->printlf("execFunWithRetWrapper", diff.count(), nullptr, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), RuntimeInternalsTrait<gmt_tag>::ThisLocality(), args_size - sizeof(functionPtr), sizeof(ResT));
#endif
            }
            ...
            inline void forEachWrapper(uint64_t startIt, uint64_t numIters,
                ...
                *reinterpret_cast<FunctionTy *>(const_cast<void *>(args));
                ...
                std::chrono::duration<double> diff = t2-t1;
                auto log_handler = shad::slog::ShadLog::Instance();
                log_handler->printlf("forEachWrapper", diff.count(), nullptr, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), RuntimeInternalsTrait<gmt_tag>::ThisLocality(), sizeof(argSize), 0, numIters);
#endif
            }
            ...
            inline void execAsyncFunWrapper(const void *args, uint32_t args_size, void *,
                ...
                std::chrono::duration<double> diff = t2-t1;
                auto log_handler = shad::slog::ShadLog::Instance();
                log_handler->printlf("execAsyncFunWrapper", diff.count(), &H, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), RuntimeInternalsTrait<gmt_tag>::ThisLocality(), args_size - sizeof(functionPtr), 0);
#endif
            }
            ...
            void asyncExecFunWithRetWrapper(const void *args, uint32_t args_size,
                ...
                *resSize = sizeof(ResT);
                ...
                std::chrono::duration<double> diff = t2-t1;
                auto log_handler = shad::slog::ShadLog::Instance();
                log_handler->printlf("asyncExecFunWithRetWrapper", diff.count(), &H, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), RuntimeInternalsTrait<gmt_tag>::ThisLocality(), args_size - sizeof(functionPtr), sizeof(ResT));
#endif
            }
            ...
            inline void asyncExecFunWithRetBuffWrapper(const void *args, uint32_t argsSize,
                ...
                std::chrono::duration<double> diff = t2-t1;
                auto log_handler = shad::slog::ShadLog::Instance();
                log_handler->printlf("asyncExecFunWithRetBuffWrapper", diff.count(), &H, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), RuntimeInternalsTrait<gmt_tag>::ThisLocality(), argsSize - sizeof(functionPtr), sizeof(*resultSize));
#endif
            }
            ...
            inline void asyncForEachWrapper(uint64_t startIt, uint64_t numIters,
                ...
                std::chrono::duration<double> diff = t2-t1;
                auto log_handler = shad::slog::ShadLog::Instance();
                log_handler->printlf("asyncForEachWrapper", diff.count(), &H, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), RuntimeInternalsTrait<gmt_tag>::ThisLocality(), sizeof(argSize), 0, numIters);
#endif
            }
