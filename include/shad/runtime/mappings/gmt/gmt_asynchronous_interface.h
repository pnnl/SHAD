            ...
            struct AsynchronousInterface<gmt_tag> {
                ...
                static void asyncExecuteAt(Handle &handle, const Locality &loc,
                    ...
                    *reinterpret_cast<FunctionTy *>(const_cast<uint8_t *>(buffer.get())) = fn;
                    ...
                    std::chrono::duration<double> diff = t2-t1;
                    auto log_handler = shad::slog::ShadLog::Instance();
                    log_handler->printlf("asyncExecuteAt", diff.count(), &handle, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), loc, sizeof(std::shared_ptr<uint8_t>),0);
#endif
                }
                ...
                static void asyncExecuteAtWithRetBuff(
                    ...
                    *reinterpret_cast<FunctionTy *>(const_cast<uint8_t *>(buffer.get())) = fn;
                    ...
                    std::chrono::duration<double> diff = t2-t1;
                    auto log_handler = shad::slog::ShadLog::Instance();
                    log_handler->printlf("asyncExecuteAtWithRetBuff", diff.count(), &handle, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), loc, sizeof(std::shared_ptr<uint8_t>),0);
#endif
                }
                ...
                static void asyncExecuteAtWithRet(Handle &handle, const Locality &loc,
                    ...
                    *reinterpret_cast<FunctionTy *>(const_cast<uint8_t *>(buffer.get())) = fn;
                    ...
                    std::chrono::duration<double> diff = t2-t1;
                    auto log_handler = shad::slog::ShadLog::Instance();
                    log_handler->printlf("asyncExecuteAtWithRet", diff.count(), &handle, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), loc, sizeof(std::shared_ptr<uint8_t>),0);
#endif
                }
                ...
                static void asyncExecuteOnAll(Handle &handle, FunT &&function,
                    ...
                    *reinterpret_cast<FunctionTy *>(const_cast<uint8_t *>(buffer.get())) = fn;
                    ...
                    std::chrono::duration<double> diff = t2-t1;
                    auto log_handler = shad::slog::ShadLog::Instance();
                    log_handler->printlf("asyncExecuteOnAll", diff.count(), &handle, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), RuntimeInternalsTrait<gmt_tag>::ThisLocality(), sizeof(std::shared_ptr<uint8_t>),0);
#endif
                }
                ...
                static void asyncForEachAt(Handle &handle, const Locality &loc,
                    ...
                    *reinterpret_cast<FunctionTy *>(basePtr) = fn;
                    ...
                    std::chrono::duration<double> diff = t2-t1;
                    auto log_handler = shad::slog::ShadLog::Instance();
                    log_handler->printlf("asyncForEachAt", diff.count(), &handle, RuntimeInternalsTrait<gmt_tag>::ThisLocality(), loc, sizeof(std::shared_ptr<uint8_t>),0, numIters);
#endif
                }
