...
using hashmap_t = shad::Hashmap<int, int, shad::MemCmp<int>, shad::Updater<int>>;
...
using shad_buffered_inserter_t = shad::buffered_insert_iterator<shad::unordered_map<int, int>>;


std::pair<iterator, iterator> shad_minmax_algorithm(shad::unordered_map<int, int> &in){
